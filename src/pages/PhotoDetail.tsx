...
const PhotoDetail = () => {
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <button onClick={() => navigate("/photography")} className="text-accent hover:underline">
            Back to Photography
          </button>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-16">
        <div className="max-w-5xl mx-auto px-6 py-12 lg:py-20">
          ...
          <motion.div
            ...
            className="mb-10 space-y-1 text-sm"
          >
          ...
          <motion.p
            ...
            className="text-muted-foreground leading-relaxed text-base max-w-3xl"
          >
            {photo.description}
          </motion.p>
        </div>
      ...
      {lightboxOpen && (
        <Lightbox
          images={[{ src: photo.image, caption: photo.title }]}
          currentIndex={0}
