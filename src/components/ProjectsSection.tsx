                ...
                >
                  <div className="aspect-[4/3] overflow-hidden relative">
                    <img
                      src={project.image}
                      alt={project.title}
                      className="w-full h-full object-cover transition-all duration-700 grayscale invert-[0.05] contrast-[1.8] brightness-[1.3] group-hover:grayscale-0 group-hover:invert-0 group-hover:contrast-100 group-hover:brightness-100 group-hover:scale-105"
                    />
